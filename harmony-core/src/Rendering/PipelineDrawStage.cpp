...
harmony::PipelineDrawStage::PipelineDrawStage(const std::string& name, Type stageType, WeakRef<ShaderProgram> shader, WeakRef<PipelineStageRenderer> stageRenderer, Attachment::Type attachments) :
	m_Name(name), 
...
harmony::PipelineDrawStage::Data harmony::PipelineDrawStage::Init(entt::registry& registry, WeakRef<View> view, bgfx::ViewId viewId)
{
	if (view.expired())
	{
...
void harmony::PipelineDrawStage::Cleanup(WeakRef<View> view, bgfx::ViewId viewId)
{
}
