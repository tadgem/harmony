...
void harmony::SubDivScreenQuadRenderer::Draw(entt::registry &scene, harmony::Ref<harmony::ShaderProgram> shader,Ref<View> view,
											 bgfx::ViewId viewId)
{
	DrawMesh(viewId, shader);
}

harmony::SubDivScreenQuadRenderer::SubDivScreenQuadRenderer(uint16_t wcount, uint16_t hcount) : PipelineStageRenderer(
		"SubDivScreenQuad")
{
