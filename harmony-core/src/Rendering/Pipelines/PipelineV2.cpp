...
harmony::PipelineV2::AddFramebuffer(const String& name, harmony::Vector<harmony::AttachmentType> attachments, harmony::Resolution::Type resolutionType) {
...
void harmony::PipelineV2::SetOutputFramebuffer(harmony::WeakRef<harmony::Framebuffer> framebuffer)
{
    ...
    {
        harmony::log::error("Pipeline : {} : Attempting to set output framebuffer : {} : but it is not a part of this pipeline", m_Name, fb->m_Name);
        return;
    }
