...
void harmony::BlinnPhongDataSource::OnPreUpdate(entt::registry &registry, Ref<ShaderProgram> shader)
{
	...
	{
		// Point Light
		bgfx::setUniform(m_PointLightAmbientArrayUniform, &m_PointLightAmbient[0],
						 m_PointLightAmbientArrayUniform.ArraySize);
		bgfx::setUniform(m_PointLightDiffuseArrayUniform, &m_PointLightDiffuse[0],
						 m_PointLightDiffuseArrayUniform.ArraySize);
		bgfx::setUniform(m_PointLightPositionArrayUniform, &m_PointLightPosition[0],
						 m_PointLightPositionArrayUniform.ArraySize);
		bgfx::setUniform(m_PointLightParamsArrayUniform, &m_PointLightParams[0],
						 m_PointLightParamsArrayUniform.ArraySize);
	}
	if (numSpotLights > 0)
	{
		// Spot Light
		bgfx::setUniform(m_SpotLightAmbientArrayUniform, &m_SpotLightAmbient[0],
						 m_SpotLightAmbientArrayUniform.ArraySize);
		bgfx::setUniform(m_SpotLightDiffuseArrayUniform, &m_SpotLightDiffuse[0],
						 m_SpotLightDiffuseArrayUniform.ArraySize);
		bgfx::setUniform(m_SpotLightPositionArrayUniform, &m_SpotLightPosition[0],
						 m_SpotLightPositionArrayUniform.ArraySize);
		bgfx::setUniform(m_SpotLightDirectionArrayUniform, &m_SpotLightDirection[0],
						 m_SpotLightDirectionArrayUniform.ArraySize);
