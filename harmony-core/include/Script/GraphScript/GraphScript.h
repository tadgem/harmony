...
namespace harmony
{
	namespace GraphScript
	{
		...
		template<typename T> class IVariableT : public IVariable
		{
		public:
			virtual T *Get() = 0;
			virtual void Set(const T &value) = 0;
		};
		template<typename T> class HeapVariable : public IVariableT<T>
		{
		public:
			template<typename... Args> explicit HeapVariable(Args &&...args)
			{
		...
		template<typename T> class IGraphNodeIOT : public IGraphNodeIO
		{
		public:
