...
inline static std::string sk_PipelineObject = "pipeline";
inline static std::string sk_PipelineStages = "stages";
inline static std::string sk_PipelineName = "name";
inline static std::string sk_PipelineType = "type";
inline static std::string sk_PipelineStageName = "m_Name";
...
inline static std::string sk_PipelineStackPipelines = "pipelines";
inline static std::string sk_PipelineStackPostProcessStages = "post-process-stages";
