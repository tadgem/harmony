...
namespace harmony {
    ...
    public:
        ...
        WeakRef<Framebuffer>
        AddFramebuffer(const String &name, Vector<AttachmentType> attachments, Resolution::Type resolutionType);
    ...
    protected:
        ...
        Ref<Framebuffer> CreateFrambufferInternal(const String &name, Vector<AttachmentType> attachments,
