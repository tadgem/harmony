...
inline void ImBitArrayClearBit(ImU32 * arr, int
n)
{
ImU32 mask = (ImU32) 1 << (n & 31);
arr[n >> 5] &= ~
...
inline void ImBitArraySetBit(ImU32 * arr, int
n)
{
ImU32 mask = (ImU32) 1 << (n & 31);
arr[n >> 5] |=
...
inline void ImBitArraySetBitRange(ImU32 * arr, int
n,
int n2
) // Works on range [n..n2)
{
...
enum ImGuiSelectableFlagsPrivate_ {
    ...
    ImGuiSelectableFlags_NoSetKeyOwner = 1
            << 28,  // Don't set key/input owner on the initial click (note: mouse buttons are keys! often, the key in question will be ImGuiKey_MouseLeft!)
};
...
namespace ImGui {
    ...
    IMGUI_API void RemoveContextHook(ImGuiContext * context, ImGuiID
    hook_to_remove);

    IMGUI_API void CallContextHooks(ImGuiContext * context, ImGuiContextHookType
    type);
...
//#endif
    ...
    IMGUI_API void GetTypematicRepeatRate(ImGuiInputFlags
    flags,
    float *repeat_delay,
    float *repeat_rate
    );
    ...
    IMGUI_API void
            DockContextClearNodes(ImGuiContext * ctx, ImGuiID
    root_id,
    ...
    IMGUI_API void
            DockContextQueueDock(ImGuiContext * ctx, ImGuiWindow * target, ImGuiDockNode * target_node,
                                 ImGuiWindow * payload,
                                 ImGuiDir
    split_dir,
    float split_ratio,
    ...
    IMGUI_API ImGuiDockNode *DockContextFindNodeByID(ImGuiContext * ctx, ImGuiID
    id);
    ...
    IMGUI_API void DebugNodeDockNode(ImGuiDockNode * node,
    const char *label
    );
