...
void harmony::GfxDebug::drawLineList(Channel channel, uint32_t _numVertices, const DdVertex* _vertices, uint32_t _numIndices, const uint16_t* _indices)
{
    for (int i = 0; i < p_DebugRenderers[channel].size(); i++)
    {
...
void harmony::GfxDebug::drawTriList(Channel channel, uint32_t _numVertices, const DdVertex* _vertices, uint32_t _numIndices, const uint16_t* _indices)
{
    for (int i = 0; i < p_DebugRenderers[channel].size(); i++)
    {
...
void harmony::GfxDebug::drawArc(Channel channel, Axis::Enum _axis, float _x, float _y, float _z, float _radius, float _degrees)
{
    for (int i = 0; i < p_DebugRenderers[channel].size(); i++)
    {
...
void harmony::GfxDebug::drawCircle(Channel channel, const bx::Vec3& _normal, const bx::Vec3& _center, float _radius, float _weight)
{
    for (int i = 0; i < p_DebugRenderers[channel].size(); i++)
    {
...
void harmony::GfxDebug::drawCircle(Channel channel, Axis::Enum _axis, float _x, float _y, float _z, float _radius, float _weight)
{
    for (int i = 0; i < p_DebugRenderers[channel].size(); i++)
    {
...
void harmony::GfxDebug::drawQuad(Channel channel, SpriteHandle _handle, const bx::Vec3& _normal, const bx::Vec3& _center, float _size)
{
    for (int i = 0; i < p_DebugRenderers[channel].size(); i++)
    {
...
void harmony::GfxDebug::drawQuad(Channel channel, bgfx::TextureHandle _handle, const bx::Vec3& _normal, const bx::Vec3& _center, float _size)
{
    for (int i = 0; i < p_DebugRenderers[channel].size(); i++)
    {
        p_DebugRenderers[channel][i]->drawQuad(_handle, _normal, _center, _size);
...
void harmony::GfxDebug::drawAxis(Channel channel, float _x, float _y, float _z, float _len, Axis::Enum _highlight, float _thickness)
{
    for (int i = 0; i < p_DebugRenderers[channel].size(); i++)
    {
...
void harmony::GfxDebug::drawGrid(Channel channel, const bx::Vec3& _normal, const bx::Vec3& _center, uint32_t _size, float _step)
{
    for (int i = 0; i < p_DebugRenderers[channel].size(); i++)
    {
...
void harmony::GfxDebug::drawGrid(Channel channel, Axis::Enum _axis, const bx::Vec3& _center, uint32_t _size, float _step)
{
    for (int i = 0; i < p_DebugRenderers[channel].size(); i++)
    {
