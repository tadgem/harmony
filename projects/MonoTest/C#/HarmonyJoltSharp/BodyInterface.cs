...
namespace HarmonyJoltSharp
{
    ...
    public readonly struct BodyInterface : IEquatable<BodyInterface>
    {
        ...
        public static BodyInterface Null => new BodyInterface(IntPtr.Zero);
        public static implicit operator BodyInterface(IntPtr handle) => new BodyInterface(handle);
        ...
        {
            return new BodyID(JPH_BodyInterface_CreateAndAddBody(Handle, settings.Handle, activationMode));
        }
