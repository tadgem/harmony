...
namespace HarmonyJoltSharp
{
    ...
    {
        public TempAllocator(uint identifier = UInt32.MaxValue)
        {
        ...
        public static TempAllocator Null => new TempAllocator(IntPtr.Zero);
        public static implicit operator TempAllocator(IntPtr handle) => new TempAllocator(handle);
