...
namespace HarmonyJoltSharp
{
    ...
    {
        private static readonly Dictionary<IntPtr, PhysicsSystem> s_contactListeners = new Dictionary<IntPtr, PhysicsSystem>();
        private static readonly Dictionary<IntPtr, PhysicsSystem> s_bodyActivationListenerListeners = new Dictionary<IntPtr, PhysicsSystem>();
        ...
        public BodyInterface BodyInterfaceNoLock => new BodyInterface(JPH_PhysicsSystem_GetBodyInterfaceNoLock(Handle));

        public BodyLockInterface BodyLockInterface => new BodyLockInterface(JPC_PhysicsSystem_GetBodyLockInterface(Handle));
        public BodyLockInterface BodyLockInterfaceNoLock => new BodyLockInterface(JPC_PhysicsSystem_GetBodyLockInterfaceNoLock(Handle));

        public NarrowPhaseQuery NarrowPhaseQuery => new NarrowPhaseQuery(JPC_PhysicsSystem_GetNarrowPhaseQuery(Handle));
        public NarrowPhaseQuery NarrowPhaseQueryNoLock => new NarrowPhaseQuery(JPC_PhysicsSystem_GetNarrowPhaseQueryNoLock(Handle));
