...
namespace HarmonyJoltSharp
{
    ...
    public struct Double3 : IEquatable<Double3>, IFormattable
    {
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => new Double3(0, 0, 1);
        }

        public double this[int index] => GetElement(this, index);
        ...
        public static implicit operator Vector3(Double3 xyz) => new Double3((float)xyz.X, (float)xyz.Y, (float)xyz.Z);

        /// <summary>
        /// Casts a <see cref="Vector3"/> value to a <see cref="Double3"/> one.
        /// </summary>
        /// <param name="xyz">The input <see cref="Vector3"/> value to cast.</param>
        public static explicit operator Double3(Vector3 xyz) => new Double3(xyz);
