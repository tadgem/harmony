...
das::Module_dasStbImage::Module_dasStbImage() : Module("stbimage")
{
    
}

bool das::Module_dasStbImage::initDependencies()
{
    ModuleLibrary lib;
    lib.addModule(this);
...
REGISTER_MODULE_IN_NAMESPACE(Module_dasStbImage,das);